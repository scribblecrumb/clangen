...
INJURY_GROUPS = {
    ...
    "blunt_force_injury": ["broken_bone", "broken_back", "head_damage", "broken_jaw"],
    "hot_injury": ["heat exhaustion", "heat stroke", "dehydrated"],
    "cold_injury": ["dangerously_cold", "frostbite"],
    "big_bite_injury": [
        "bite_wound",
        "broken_bone",
        "torn pelt",
    ...
    "small_bite_injury": ["bite_wound", "torn_ear", "torn pelt", "scrapes"],
    "beak_bite": ["beak_bite", "torn_ear", "scrapes"],
    "rat_bite": ["rat_bite", "torn_ear", "torn pelt"],
